...
/**
 * Class containing tests for Slavery Abolition Day in Mayotte (France).
 */
class SlaveryAbolitionTest extends MayotteBaseTestCase implements YasumiTestCaseInterface
{
    /**
    ...
    {
        return $this->generateRandomDates(4, 27, self::TIMEZONE);
    }
}
