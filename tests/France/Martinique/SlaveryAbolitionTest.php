...
/**
 * Class containing tests for Slavery Abolition Day in Martinique (France).
 */
class SlaveryAbolitionTest extends MartiniqueBaseTestCase implements YasumiTestCaseInterface
{
    /**
    ...
    {
        return $this->generateRandomDates(5, 22, self::TIMEZONE);
    }
}
