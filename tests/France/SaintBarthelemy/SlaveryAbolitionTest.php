...
/**
 * Class containing tests for Slavery Abolition Day in SaintBarthelemy (France).
 */
class SlaveryAbolitionTest extends SaintBarthelemyBaseTestCase implements YasumiTestCaseInterface
{
    /**
    ...
    {
        return $this->generateRandomDates(10, 9, self::TIMEZONE);
    }
}
