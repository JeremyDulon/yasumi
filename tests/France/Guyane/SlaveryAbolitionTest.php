...
/**
 * Class containing tests for Slavery Abolition Day in Guyane (France).
 */
class SlaveryAbolitionTest extends GuyaneBaseTestCase implements YasumiTestCaseInterface
{
    /**
    ...
    {
        return $this->generateRandomDates(6, 10, self::TIMEZONE);
    }
}
