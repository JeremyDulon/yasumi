...
/**
 * Class containing tests for Slavery Abolition Day in Guadeloupe (France).
 */
class SlaveryAbolitionTest extends GuadeloupeBaseTestCase implements YasumiTestCaseInterface
{
    /**
