...
/**
 * Class containing tests for Slavery Abolition Day in Reunion (France).
 */
class SlaveryAbolitionTest extends ReunionBaseTestCase implements YasumiTestCaseInterface
{
    /**
    ...
    {
        return $this->generateRandomDates(12, 20, self::TIMEZONE);
    }
}
